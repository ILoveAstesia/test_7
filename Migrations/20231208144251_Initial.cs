    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClazzsNeedToStudyId = table.Column<int>(type: "int", nullable: false),
                    StudentsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassStudent", x => new { x.ClazzsNeedToStudyId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_ClassStudent_Clazzs_ClazzsNeedToStudyId",
                        column: x => x.ClazzsNeedToStudyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClazzsNeedtoTeachId = table.Column<int>(type: "int", nullable: false),
                    TeachersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassTeacher", x => new { x.ClazzsNeedtoTeachId, x.TeachersId });
                    table.ForeignKey(
                        name: "FK_ClassTeacher_Clazzs_ClazzsNeedtoTeachId",
                        column: x => x.ClazzsNeedtoTeachId,
                        principalTable: "Clazzs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
